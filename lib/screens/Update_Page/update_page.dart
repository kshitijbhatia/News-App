...
class _UpdatePageState extends State<UpdatePage> {
          ...
          children: [
            ...
            GestureDetector(
              onTap: () async  {
                ...
                if(file == null)return;
                final response = await provider.updateImage(widget.user, file, context);
                if(response != null){
            ...
            Row(
              ...
              children: [
                TextButton(
                  onPressed: (){
                    provider.deleteAccount(widget.user, context);
                  },
                  style: ButtonStyle(
                ...
                TextButton(
                    onPressed: (){
                      if(_formKey.currentState!.validate()){
                        ...
                        updateProvider.updateDetails(widget.user, newName, newEmail, newPassword, context);
                      }
                    },
                    style: ButtonStyle(
  ...
  _userProfilePicture(){
    ...
    double height = ScreenSize.getHeight(context);
    final updateProvider = Provider.of<UpdateProvider>(context);
    if(updateProvider.imageUpdateComplete) {
      return Center(
        child: Container(
          width: width/2,
          height: height/4,
